...
#### 3. 📁 `akses_dan_kesempatan`(5 fitur)
...
#### 4. 📁 `kedekatan_emosional_lain` (4 fitur) ⚠️
...
**Insight**: Status ≠ komitmen - banyak yang menikah/punya anak tapi komitmen lemah.

#### 7. 📁 `pemicu_stres` (4 fitur)
...
- Emotional infidelity score ≥ 0.5
